  ...
  return (
    <div className="registration-page">
      ...
      <header className="topbar">
        <a className="brand" href="#top" aria-label="FireGuard home">
      ...
      <footer>
        <span>© 2026 FireGuard Service Management System</span>
...
const pageStyles = `
  ...
  * { box-sizing: border-box; }
  ...
  .brand-mark {
    ...
    background: #fff5f5;
    clip-path: polygon(50% 0, 92% 16%, 86% 73%, 50% 100%, 14% 73%, 8% 16%);
  }
  .brand-mark svg { width: 28px; }
  .brand > span:last-child { display: grid; }
  .brand strong { font-size: 21px; line-height: 1; letter-spacing: -.4px; }
  .brand small { margin-top: 5px; color: var(--muted); font-size: 11px; letter-spacing: .055em; text-transform: uppercase; }
  ...
  .brand-mark {
    ...
    height: 47px;
    color: #fff;
    border: 1px solid rgba(255,126,74,.52);
    background: linear-gradient(145deg, #ff7842, #d72431 72%);
    filter: drop-shadow(0 8px 14px rgba(220,39,47,.22));
  }
  .brand-mark svg { width: 25px; }
  .brand strong { letter-spacing: -.03em; }
  .brand small { color: #747d8c; }
